    ...
    <ParaTimeContent
      description={
        <Trans
          ...
          defaults='Please enter the amount of ROSE tokens you wish to transfer {{actionType}} wallet on the <strong>{{paraTime}}</strong> {{paratimeType}} ParaTime and then click "Next"'
        />
      }
      isLoading={isLoading}
    >
