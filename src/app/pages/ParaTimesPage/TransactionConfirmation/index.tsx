...
export const TransactionConfirmation = () => {
  ...
  const { isDepositing, isEvmcParaTime, paraTimeName, setTransactionForm, transactionForm } = useParaTimes()
    ...
    <ParaTimeContent
      description={
        <Trans
          ...
          defaults="You are about to transfer <strong>{{value}} ROSE</strong> tokens {{actionType}} wallet on the <strong>{{paraTime}}</strong> {{isEvmc}} ParaTime: <strong>{{address}}</strong>"
        />
      }
    >
