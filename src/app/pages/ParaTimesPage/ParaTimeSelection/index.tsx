      ...
      description={
        isDepositing
          ? t(
              ...
              'Please select which ParaTime you wish to transfer your ROSE tokens to and then click "Next".',
            )
          : t(
              'paraTimes.selection.withdrawDescription',
              'Please select which ParaTime you wish to withdraw your ROSE tokens from and then click "Next".',
            )
      }
    >
      <Form
